...
dropout_list       = [0]    # the fractions of edges dropped
n_runs             = 10                  # the number of runs for each dropout fraction over which is averaged
save_switch        = False               # True: save all figures. False: show
...
for method in method_names:
    ...
    for dropout in dropout_list:
        ...
        for train_index, validation_index in rs.split(edge_list):
            ...
            lp[method].check_selection_rules()
