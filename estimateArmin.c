...
/* This is a slighly changed version of the code which also outputs group
 * vectors
 * Written by Armin Kekic  24 JUL 2016
 */
...
// Note: this has been changed to be the first command line argument
...
{
  int u,r,s;
  int const MCSWEEPS = atoi(argv[1]);
